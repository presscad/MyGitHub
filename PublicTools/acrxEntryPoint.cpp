...
void initApp()
{
	...
	//	_T("XHTOOLS"), //输入这两个命令名称均可以在
	//	_T("XHTOOLS"), //AutoCAD中运行该程序
	//	ACRX_CMD_MODAL,
	//	turnOnOneOfAttribute); //处理函数

	acedRegCmds->addCommand(groupName, _T("READTABLE"), _T("READTABLE"), ACRX_CMD_MODAL, readTableToExcel); //处理函数
